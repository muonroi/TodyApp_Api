...
namespace RemindApp.Data.Persistence.Migrations
{
    ...
    [Migration("20250419154509_UpdateTodoListv2")]
    partial class UpdateTodoListv2
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("RemindApp.Core.Domain.ReminderSettingEntity", b =>
                {
                    ...
                    b.Property<int>("ReminderAgainTimeOfMinute")
                        .HasColumnType("integer")
                        .HasColumnOrder(3);

                    b.Property<int>("ReminderSystem")
                        .HasColumnType("integer")
                        .HasColumnOrder(2);

                    b.HasKey("Id");

                    b.ToTable("ReminderSetting");
                });

            modelBuilder.Entity("RemindApp.Core.Domain.TodoListEntity", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<bool?>("ReminderRepeats")
                        .HasColumnType("boolean")
                        .HasColumnOrder(9);
